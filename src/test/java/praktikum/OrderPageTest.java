...
public class OrderPageTest {
    ...
    public static Object[][] getRecipientsDetails() {
        ...
        return new Object[][]{
                {"Светлана","Старикова","Ленина, 13","3","89136549889","24","7","серая безысходность","Спасибо за работу"},
                {"Антон","Чехов","улица Кирова, дом 7","8","89999999889","9","1","чёрный жемчуг","Отдуши <3"}
        };
    }
